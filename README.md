...
VMware Workstation Player est une application d’hyperviseur des postes de travail, avec des fonctionnalités de virtualisation locale, disponible gratuitement pour une utilisation à titre personnel.
...
Oracle VM VirtualBox, le logiciel de virtualisation multiplateforme à code source ouvert le plus populaire au monde, permet aux développeurs de fournir du code plus rapidement en exécutant plusieurs systèmes d’exploitation sur un seul terminal.
